...
public final class AssetTransfer implements ContractInterface {
    ...
    /**
     * Duplicates and assigns the duplicate to the new owner while keeping
     * the original asset with the previous original owner of the asset on the ledger.
     *
     * @param ctx the transaction context
     * @param assetID the ID of the asset being transferred
     * @param newAssetID the ID of the duplicate asset
     * @param newOwner the new owner
